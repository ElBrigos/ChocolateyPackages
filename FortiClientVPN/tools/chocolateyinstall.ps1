...
$url        = 'https://filestore.fortinet.com/forticlient/FortiClientVPNOnlineInstaller.exe' # download url, HTTPS preferred
$url64      = '' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url

$packageArgs = @{
  packageName   = $env:forticlientvpn
  ...
  softwareName  = 'FortiClient VPN*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
